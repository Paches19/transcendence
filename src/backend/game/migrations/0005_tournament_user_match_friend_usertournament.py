...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('game', '0004_remove_match_tournamentid_remove_match_user1_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tournamentId', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='game.tournament')),
                ('user1', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='user1_match', to='game.user')),
                ('user2', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='user2_match', to='game.user')),
            ],
        ),
        migrations.CreateModel(
            name='Friend',
            fields=[
                ...
                ('user1', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='user1', to='game.user')),
                ('user2', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='user2', to='game.user')),
            ],
        ),
        migrations.CreateModel(
            name='UserTournament',
